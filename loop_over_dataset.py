...
# Note: options not in the list will be loaded from file
# exec_detection options are:
    ...
    try:
        ...
        if 'perform_tracking' in exec_list:
            ...
            for detection in detections:
                ...
                if configs_det.lim_x[0] < detection[1] < configs_det.lim_x[1] and \
                   configs_det.lim_y[0] < detection[2] < configs_det.lim_y[1]:
